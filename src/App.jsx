...
import GatCoursesPage from './components/student/GatCoursesPage';
...
const App = () => {
  ...
  // Handle navigating to GAT courses page
  const handleNavigateToGatCourses = () => {
    setCurrentView('gatCourses');
  };
  
  // Handle selecting a course type (math or arabic)
  const handleSelectCourseType = (type) => {
    setSelectedCourseType(type);
    setSelectedCourseFolder(null);
    setSelectedCourseVideo(null);
  };
  
  // Handle selecting a course folder
  const handleSelectCourseFolder = (folder) => {
    setSelectedCourseFolder(folder);
    setSelectedCourseVideo(null);
  };
  
  // Handle selecting a course video
  const handleSelectCourseVideo = (video) => {
      ...
      case 'studentDashboard':
        return (
          <StudentDashboard 
            ...
            onNavigateToGatCourses={handleNavigateToGatCourses}
      ...
      case 'gatCourses':
        return (
          <GatCoursesPage 
            ...
            selectedFolder={selectedCourseFolder}
            selectedVideo={selectedCourseVideo}
            onSelectType={handleSelectCourseType}
            onSelectFolder={handleSelectCourseFolder}
            onSelectVideo={handleSelectCourseVideo}
            onBack={() => setCurrentView('studentDashboard')} 
          />
        );
